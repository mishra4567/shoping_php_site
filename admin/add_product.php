                ...
                <div class="card">
                    <div class="card-body card-block">
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-3 ">
                                <label for="image" class="from-control-label fwold">Product Image</label>
                                <input type="file" name="image" class="form-control" id="" accept=".jpg,.png,.jpeg" <?php echo $image_required ?>>
                            </div>
                            <div class="form-group mt-3 ">
